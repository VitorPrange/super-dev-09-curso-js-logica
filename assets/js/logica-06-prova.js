...
function sistemaCadastroValidado(){
    let quantidadeCadastrar = parseInt(prompt("Digite a quantidade de funcionarios que deseja cadastrar"));
    let quantidadeAtendentes = 0;
    ...
    let contadorIdade18 = 0;
    let contadorIdadeMenor18 = 0;
    ...
    for(let i = 0; i < quantidadeCadastrar; i = i + 1){
        ...
        if(idade >= 18){
            contadorIdade18 = contadorIdade18 + 1;
        }
    ...
    let mediaSalarial = somaSalarios / quantidadeCadastrar;

    alert(
        "Quantidade total de funcionarios cadastrados: " + quantidadeCadastrar + 
        "\nQuantidade de atendentes: " + quantidadeAtendentes + 
        "\nQuantidade de gerentes: " + quantidadeGerentes + 
        "\nQuantidade de vendedores: " + quantidadeVendedores + 
        "\nQuantidade de maiores de idade: " + contadorIdade18 + 
        "\nQuantidade de menores de idade: " + contadorIdadeMenor18 + 
        "\nSoma total dos salarios: " + somaSalarios + 
        "\nMedia salarial: " + mediaSalarial + 
        "\nNome do funcionario com maior salario: " + nomeMaiorSalario + 
        "\nMaior salario: " + maiorSalario +
        "\nNome do funcionario com menor salario: " + nomeMenorSalario + 
