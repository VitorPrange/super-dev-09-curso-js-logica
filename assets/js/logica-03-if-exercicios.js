...
function exercicio20() {
    ...
    if (operacao === 1) {
        ...
        alert("Sem divisão por 0 espertinho");
    }
    else {
...
function exercicio32() {
    let numero1 = parseInt(prompt("Informe o numero"));
...
function exercicio33() {
    let numero1 = parseInt(prompt("Informe o numero"));
    let numero2 = parseInt(prompt("Informe o numero"));
    let diferenca = numero1 - numero2;

    if(diferenca > 0){

        alert("Resultado e positivo");
    }
    else if(diferenca === 0){

        alert("Resultado e ZERO");
    }
    else if(diferenca < 0){

        alert("Resultado e negativo");
    }
}
...
function exercicio34() {
    let numero1 = parseInt(prompt("Informe o numero"));
    let numero2 = parseInt(prompt("Informe o numero"));
    let numero3 = parseInt(prompt("Informe o numero"));
...
function exercicio35() {
    ...
    if(Math.abs(numero1) >= 10){
        alert("Tem mais de 1 digito");
    }else{
        alert("Tem 1 digito");
    }
}
...
function exercicio36() {
    ...
    if(numero1 >= 0 && numero1 <= 10){
        ...
        alert("Faz parte do conjunto 0-10");
    }
    else if(numero1 > 10 && numero1 <= 20){

        alert("Faz parte do conjunto 11-20");
    }
    else if(numero1 > 20 && numero1 <= 30){

        alert("Faz parte do conjunto 21-30");
    }
    else if(numero1 > 30 && numero1 <= 40){

        alert("Faz parte do conjunto 31-40");
    }else{
        alert("Não faz parte dos conjuntos estabelecidos");
    }
}
...
function exercicio37() {
    ...
    if(numero1 === numero2){
        alert("Os doid numeros são iguais");
    }
    else if((numero1 !== numero2) && (numero1 > numero2)){
        alert("Os doid numeros são diferentes e o maior dentre ele é o: " + numero1);
    }
    else if((numero1 !== numero2) && (numero1 < numero2)){
        alert("Os doid numeros são diferentes e o maior dentre ele é o: " + numero2);
    }
}
...
function exercicio38() {
    ...
    if((numero1 < 0) || (numero2 < 0) || (numero3 < 0)){
        alert("Ao menos 1 é negativo");
    }
    else{
        alert("Nenhum é negativo");
    }
}
...
function exercicio39() {
    ...
    if((numero1 > 0) && ((numero2 < 0) || (numero3 < 0))){
        alert("Apenas um é positivo");
    }
    else if((numero2 > 0) && ((numero1 < 0) || (numero3 < 0))){
        alert("Apenas um é positivo");
    }
    else if((numero3 > 0) && ((numero1 < 0) || (numero2 < 0))){
        alert("Apenas um é positivo");
    }
}
...
function exercicio40() {
    ...
    if(numero1 % numero2 === 0){
        alert("Numero " + numero1 + "é multiplo de " + numero2);
    }
    else{
...
function exercicio41() {
    ...
    if((numero1 >= 0) && (numero1 <= 100)){
        ...
        alert("Numero " + numero1 + "esta no intervalo de 0-100");
    }
    else if((numero1 > 100) && (numero1 <= 200)){

        alert("Numero " + numero1 + "esta no intervalo de 101-200");
    }
}
...
function exercicio42() {
    ...
    if((numero1 < 0) || (numero1 > 100)){
        ...
        alert("Numero " + numero1 + "esta fora do intervalo de 0-100");
    }
...
function exercicio43() {
    ...
    if((numero1 !== numero2 && numero1 !== numero3 && numero2 !== numero3)){ // apoio de IA
        alert("Não são iguais entre si");
    }
}
...
function exercicio44() {
    ...
    if((numero1 === numero2 || numero1 === numero3 || numero2 === numero3)){
        alert("Tem valores repetidos");
    }else{
        alert("Não tem valores repetidos");
    }
}
...
function exercicio45() {
    ...
    let minimo = 1500;
    let desconto = valor * 0.80;

    if(valor > minimo){
        alert("Valor com desconto: R$" + desconto);
    }else{
        alert("Não tem desconto: R$" + valor);
    }
}
...
function exercicio46() {
    ...
    if(idade < 14){
        alert("Não pode ver homem aranha longe de casa");
    }else{
        alert("Pode ver homem aranha longe de casa");
    }
}
...
function exercicio47() {
    ...
    if(numero % 10 === 0){
        ...
        alert("É divisivel por dez");
    }else if(numero % 5 === 0){

        alert("É divisivel por cinco");
    }
}
...
function exercicio48() {
    ...
    if((numero1 >= 0 && numero1 <= 100) && (numero2 >= 0 && numero2 <= 100)){
        ...
        alert("Os dois fazem parte do intervalo 0-100");
    }
}
...
function exercicio49() {
    ...
    if ((numero1 + numero2 > numero3) && (numero1 + numero3 > numero2) && (numero3 + numero2 > numero1)) {
        alert("A soma de 2 dos numeros e maior que o terceiro");
    }
}
...
function exercicio50() {
    ...
    if((numero1 % 2 === 0) && (numero1 > 0)){
        alert(numero1 + " e positivo e par");
    }else{
        alert(numero1 + " não é positivo e par");
    }
}